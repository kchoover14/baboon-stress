...
#This script examines measurement error in female mandibular breadths

library(readxl)
library(dplyr)
library(tidyr)
me=read_excel("0-reps-10.xlsx", sheet="fembmn")
...
write.table(mnm2,"mnm2-femb.txt", sep = "\t")
...
write.table(mnm3,"mnm3-femb.txt", sep = "\t")
...
write.table(mnp4,"mnp4-femb.txt", sep = "\t")
