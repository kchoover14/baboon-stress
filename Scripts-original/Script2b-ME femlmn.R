...
#This script examines measurement error in female mandibular lengths

library(readxl)
library(dplyr)
library(tidyr)
me=read_excel("0-reps-10.xlsx", sheet="femlmn")
...
write.table(mnm1,"mnm1-feml.txt",sep="\t")
...
write.table(mnp4,"mnp4-feml.txt.txt",sep="\t")
