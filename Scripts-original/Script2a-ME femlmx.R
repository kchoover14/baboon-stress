...
#This script examines measurement error in female maxillary lengths

library(readxl)
library(dplyr)
library(tidyr)
me=read_excel("0-reps-10.xlsx", sheet="femlmx")
...
#Evaluate new dataframes for outliers using Rosner's ESD test
library(EnvStats)
