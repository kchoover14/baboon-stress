...
#This script examines measurement error in male maxillary breadths

library(readxl)
library(dplyr)
library(tidyr)
me=read_excel("0-reps-10.xlsx", sheet="malebmx")
...
write.table(mxm1,"mxm1-maleb.txt",sep="\t")
...
write.table(mxm2,"mxm2-maleb.txt",sep="\t")
...
write.table(mxm3,"mxm3-maleb.txt",sep="\t")
...
write.table(mxp3,"mxp3-maleb.txt",sep="\t")
...
write.table(mxp4,"mxp4-maleb.txt",sep="\t")

#Rosner's outlier detection
library(EnvStats)
rosnerTest(mxm1$mxm1, k=20, alpha=0.05, warn=TRUE)
rosnerTest(mxm2$mxm2, k=15, alpha=0.05, warn=TRUE)
rosnerTest(mxm3$mxm3, k=25, alpha=0.05, warn=TRUE)
rosnerTest(mxp3$mxp3, k=25, alpha=0.05, warn=TRUE)
rosnerTest(mxp4$mxp4, k=10, alpha=0.05, warn=TRUE)
