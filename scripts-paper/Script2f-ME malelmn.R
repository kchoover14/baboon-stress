...
#This script examines measurement error in male mandibular lengths

library(readxl)
library(dplyr)
library(tidyr)
me=read_excel("0-reps-10.xlsx", sheet="malelmn")
...
write.table(mnm2,"mnm2-malel.txt", sep = "\t")
...
write.table(mnm3,"mnm3-malel.txt", sep = "\t")
...
write.table(mnp4,"mnp4-malel.txt", sep = "\t")
...
rosnerTest(mnp4$mnp4, k=15, alpha=0.05, warn=TRUE)
